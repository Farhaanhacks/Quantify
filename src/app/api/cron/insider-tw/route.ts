...
//
// Six market-wide files — three from TWSE, three from TPEx — downloaded, parsed
// and written per company. Runs off the user path, so a stock page reads one
// Redis key instead of downloading every listed company's filings to display
// one company's.
//
