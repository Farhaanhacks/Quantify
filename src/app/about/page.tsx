...
export const metadata = {
  ...
  description:
    "Quantifi is an educational market-research and analytics platform covering news impact, research ideas, screening and a personal portfolio tracker. Not a broker or adviser.",
};
...
export default function AboutPage() {
  return (
    <LegalShell eyebrow="About" title="About Quantifi">
      ...
      <H2>Who runs it</H2>
      <p>
        Quantifi is operated by its founder as an independent product. For any question about support,
